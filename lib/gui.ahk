...
Button_potplayer.OnEvent("LoseFocus",(*) => UpdateOrIntert("path",edit_potplayer.Value))

myGui.Add("Text", "x91 y48 w63 h23", "减少的时间")
Edit_reduce_time := myGui.AddEdit( "x160 y48 w120 h21", GetKey("reduce_time"))
Edit_reduce_time.OnEvent("LoseFocus",(*) => UpdateOrIntert("reduce_time",Edit_reduce_time.Value))
...
CheckBox_remove_suffix_of_video_file.OnEvent("Click", (*) => UpdateOrIntert("remove_suffix_of_video_file",CheckBox_remove_suffix_of_video_file.Value))

CheckBox_path_is_encode := myGui.AddCheckbox("x160 y416 w120 h23", "路径是否编码")
CheckBox_path_is_encode.Value := GetKey("path_is_encode")
checkBox_path_is_encode.OnEvent("Click", (*) => UpdateOrIntert("path_is_encode",checkBox_path_is_encode.Value))
...
Edit_url_protocol.OnEvent("LoseFocus",(*) => UpdateOrIntert("url_protocol",Edit_url_protocol.Value))
...
Update_Hk_Backlink(*){
  ...
  UpdateOrIntert("hotkey_backlink",hk_backlink.Value)
}
...
Update_Hk_Image_Backlink(*){
  ...
  UpdateOrIntert("hotkey_iamge_backlink",hk_image_backlink.Value)
}
